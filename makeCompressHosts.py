...
def main():
    ...
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/fakenews-gambling",
                      "-e", "fakenews", "gambling")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/fakenews-porn",
                      "-e", "fakenews", "porn")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/fakenews-social",
                      "-e", "fakenews", "social")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/gambling-porn",
                      "-e", "gambling", "porn")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/gambling-social",
                      "-e", "gambling", "social")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/porn-social",
                      "-e", "porn", "social")

    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/fakenews-gambling-porn",
                      "-e", "fakenews", "gambling", "porn")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/fakenews-gambling-social",
                      "-e", "fakenews", "gambling", "social")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/fakenews-porn-social",
                      "-e", "fakenews", "porn", "social")
    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/gambling-porn-social",
                      "-e", "gambling", "porn", "social")

    update_hosts_file("-a", "-c", "-n", "-o",
                      "compressed/fakenews-gambling-porn-social",
